...
!(function(A, e) {
  ...
  const HA = { type: 2 },
    ...
    PA =
      ...
      (XA.prototype.consumeUnicodeRangeToken = function() {
        ...
        const r = parseInt(g.apply(void 0, A), 16);
      ...
      (XA.prototype.consumeNumber = function() {
        ...
        return [
          (function(A) {
            ...
            const B = r.length ? parseInt(g.apply(void 0, r), 10) : 0;
            46 === A[e] && e++;
            ...
            const c = Q.length ? parseInt(g.apply(void 0, Q), 10) : 0;
  ...
  const JA =
    ...
    (YA.prototype.consumeFunction = function(A) {
      for (let e = { name: A.value, values: [], type: 18 }; ; ) {
  ...
  function pe(A, t) {
    ...
    for (var i = null, s = 0; s < B.length; s++) {
      ...
      if (null === Q) null === i && (i = s);
        ...
        for (let c = s - i, a = (Q - B[i - 1]) / (1 + c), g = 1; g <= c; g++) B[i + g - 1] = a * g;
        i = null;
      }
    }
  ...
  for (
    let Er = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/',
  ...
  var br,
    ...
    Xr = {
            ...
            ? (function(t) {
              ...
              return (
                ...
                Pr(e)
                  .then(function(A) {
                    B.drawImage(A, 0, 0);
                    const e = B.getImageData(0, 0, r, r).data;
      ...
      get SUPPORT_NATIVE_TEXT_SEGMENTATION() {
        const A = !('undefined' == typeof Intl || !Intl.Segmenter);
  ...
  var gn,
    ...
    dn =
      ...
      (fn.prototype.createCustomElementClone = function(A) {
        const e = document.createElement('html2canvascustomelement');
      ...
      (fn.prototype.createStyleClone = function(A) {
        try {
          const e = A.sheet;
          if (e && e.cssRules) {
            const t = [].slice.call(e.cssRules, 0).reduce(function(A, e) {
      ...
      (fn.prototype.createVideoClone = function(e) {
        let A = e.ownerDocument.createElement('canvas');
      ...
      (fn.prototype.cloneNode = function(A, e) {
        ...
        let t = A.ownerDocument.defaultView;
        if (t && XB(A) && (JB(A) || YB(A))) {
          const r = this.createElementClone(A);
          r.style.transitionProperty = 'none';
          let B = t.getComputedStyle(A),
  ...
  const On =
    ...
    (Vn.prototype.proxy = function(s) {
      ...
      const Q = s.substring(0, 256);
      return new Promise(function(e, t) {
        const r = Xr.SUPPORT_RESPONSE_TYPE ? 'blob' : 'text',
  ...
  var hs = function(Q, c, a, g) {
    ...
    ds = function(A, e) {
      for (
        let t = A instanceof UB ? A.start : 1, r = A instanceof UB && A.reversed, B = 0;
        B < e.length;
        B++
      ) {
        const n = e[B];
  ...
  var Ls,
    ...
    bs =
      ...
      (Ds.prototype.renderStackContent = function(C) {
        return a(this, void 0, void 0, function() {
          let e, t, r, B, n, s, o, i, Q, c, a, g, w, U, l;
          return H(this, function(A) {
            switch (A.label) {
              case 0:
                return (
          ...
          return H(this, function(A) {
            switch (A.label) {
              case 0:
                ...
                (e = function(e) {
                  let t, r, B, n, s, o, i, Q, c, a, g, w, U, l, C, u, F;
                  return H(this, function(A) {
                    switch (A.label) {
                      case 0:
  ...
  const Ps = ((Xs.instanceCount = 1), Xs);
  function Xs(A, e) {
    (this.windowBounds = e),
  ...
  var Js = function(u, F) {
      return a(void 0, void 0, void 0, function() {
        let e, t, r, B, n, s, o, i, Q, c, a, g, w, U, l, C;
        return H(this, function(A) {
          switch (A.label) {
            case 0:
